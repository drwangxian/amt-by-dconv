"""
This script implements the frame-wise pitch detector of our AMT system.

How to use this code
1. Download the datasets and generate spectrograms.
2. Create a folder, e.g., maps/frame if you want to train on the MAPS dataset, and copy this
    ...
    def __init__(self):
        ...
        if self.debug_mode:
            ...
            for tvt in self.tvt_split_dict.keys():
                ...
                _sel = np.random.choice(_num, 3, replace=False)
...
def main():
    ...
    with tf.Session(config=MODEL_DICT['config'].gpu_config) as sess:
        ...
        aug_info.append('frame-wise pitch detection - trained on {}'.format(training_dataset))
